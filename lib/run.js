...
if(fs.existsSync(path.join(mdaDir,'imgSplashScreen.jpg')) == false){
  ...
  console.log(' -> '.magenta + '.mda/imgSplashScreen.jpg created'.green);
}
...
console.log('### Execution of meteor ###'.bold.green);
...
meteor.stdout.on('data', function (data) {
  ...
  if (data.toString().indexOf("=> App running at: http://localhost:3000") != -1){
